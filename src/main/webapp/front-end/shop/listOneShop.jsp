...
<div id="make-3D-space" >
    <div id="product-card">
        <div id="product-front">
         ...
         <div class="container" >
          <div>
              <img src="data:image/jpeg;base64,${sps.getOneShopPic(shopVO.itemId)} ">
             </div>
            </div>
            <div class="image_overlay"></div>
            <div id="view_details">仔細欣賞</div>
            <div class="stats">         
                <div class="stats-container">
                    <span class="product_price">$<%=shopVO.getItemFee()%></span>
                    <span class="product_name"><%=shopVO.getItemName()%></span>    
                    <p><%=shopVO.getItemDescribtion()%></p>                                            
                    
                    <div class="product-options" style="display:flex;flex-wrap:wrap;">
                    <strong>庫存</strong>
                    <span><%=shopVO.getItemQuantity()%></span>
                    <strong>評分</strong>
                    <span><%=shopVO.getCommentTotalScore()%></span>
                    <strong>評論數</strong>
                    <span><%=shopVO.getCommentNumber()%></span>
                    </div>
                    <div class="colors">
                        <div class="c-blue">
                        <span>
