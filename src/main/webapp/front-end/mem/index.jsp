...
<body>
	...
	<div class="container-login100" style="background-image: url('images/backGround.png');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post" action="/CFA101G2/mem/mem.do" name="form1">
	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li class="text-center" style="color:red">${message}</li>
				...
				<input type="hidden" name="action" value="login" /> <!-- test -->
				...
				<div class="text-center">
					<a href="addMember.jsp" class="txt2 hov1">
						註冊
					</a>
				</div>
				
				<div class="text-center">
					<a href="forgotPassWord.jsp" class="txt2 hov1">
						忘記密碼
					</a>
				</div>
			</form>
