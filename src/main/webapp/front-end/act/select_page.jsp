...
<html>
<head>
<title>Front-End Act: Home</title>
...
<table id="table-1">
   <tr><td><h3>Front-End Act: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for Front-End Act: Home</p>
...
<ul>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/act/act.do" >
       ...
       <select size="1" name="actId">
         <c:forEach var="actVO" items="${actSvc.all}" > 
          <option value="${actVO.actId}">${actVO.actFee}
         </c:forEach>   
       </select>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" value="送出">
