...
<link rel='stylesheet' id='mfn-base-css' href='https://www.ajhotel.com.tw/wp-content/themes/betheme/css/base.css?ver=21.5.9.3' type='text/css'
	media='all' />
<link rel='stylesheet' id='mfn-layout-css' href='https://www.ajhotel.com.tw/wp-content/themes/betheme/css/layout.css?ver=21.5.9.3' type='text/css'
	media='all' />
<link rel='stylesheet' id='mfn-responsive-css' href='https://www.ajhotel.com.tw/wp-content/themes/betheme/css/responsive.css?ver=21.5.9.3'
	type='text/css' media='all' />
<link rel='stylesheet' id='style-css' href='https://www.ajhotel.com.tw/wp-content/themes/betheme-child/style.css?ver=21.5.9.3' type='text/css'
	media='all' />
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-header" href="<%=request.getContextPath()%>/front-end/frontEndPage.jsp">
					<img src="https://i.imgur.com/2j6Zzxv.png" height="40" title="島旅 Island Brigade" alt="島旅 Island Brigade">
				</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-left">
					...
					<li>
						<a href="<%=request.getContextPath()%>/rmtype/RmtypeServlet?action=getAllRoomType">線上訂房</a>
					</li>
					<li>
						<a href="#">預定活動</a>
					</li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<c:if test="${memVO == null}">
							<a href="<%=request.getContextPath()%>/front-end/mem/index.jsp">
					...
					<li>
						...
						<c:if test="${memVO != null}">
							...
							歡迎:<font color=red> ${memVO.memAccount} </font>您好
							</a>
						</c:if>
					<li>
						<c:if test="${memVO != null}">
							...
							<form id="form1" method="post" action="<%=request.getContextPath()%>/mem/mem.do" name="form1">
...
<!-- 								<input type="submit" value="登出" /> -->
					...
					<li>
						<c:if test="${memVO != null}">
							...
							<a href="javascript:void(0)" onclick="document.getElementById('form2').submit();">
							<span class="glyphicon glyphicon-user"></span>
							會員中心</a>
							
							<FORM id="form2" METHOD="post" ACTION="<%=request.getContextPath()%>/mem/mem.do">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="https://i.imgur.com/G8EL2MK.jpg" alt="sea" style="width: 100% height:100%;">
				</div>
				<div class="item">
					<img src="https://i.imgur.com/0PHnaog.jpg" alt="sea" style="width: 100% height:100%;">
				</div>
				<div class="item">
					<img src="https://i.imgur.com/jvIiblK.jpg" alt="sea" style="width: 100% height:100%;">
				</div>
				<div class="item">
					<img src="https://i.imgur.com/syaT1rJ.jpg" alt="sea" style="width: 100% height:100%;">
				</div>
			</div>
			<!-- 左右控制按鈕 
			...
			<div class="container">
				<div class="column one-third">
					<aside id="media_image-2" class="widget widget_media_image">
						<img width="240" height="172" src="https://i.imgur.com/fsslT0i.png" class="image wp-image-284  attachment-full size-full" alt="島旅logo"
							style="max-width: 100%; height: auto;" srcset="" sizes="(max-width: 240px) 100vw, 240px" />
					</aside>
				</div>
				<div class="column one-third">
							...
							<div class="one mcb-wrap stand_txt">
								<div class="column one-second">
									<ul style="line-height: 38px; list-style-type: none">
										<li>
											<a href="#" target="_blank" rel="noopener noreferrer">線上訂房</a>
										</li>
										<li>
											<a href="#" target="_blank" rel="noopener noreferrer">討論區</a>
										</li>
										<li>
											<a href="#">最新消息</a>
										</li>
					...
					<aside id="text-4" class="widget widget_text">
						<div class="textwidget">
							...
							<div class="stand_txt" style="line-height: 30px; color: #ccc;">
								<img src="https://i.imgur.com/hIpnqqy.png" width="15">
								島旅縣島旅市島旅路100號
							</div>
							<div class="stand_txt" style="line-height: 30px; color: #ccc;">
								<img src="https://i.imgur.com/ajKbJzD.png" width="15">
								電話 +886-9876-5432<br />
								<img src="https://i.imgur.com/EVCq5UM.png" width="15">
								傳真 +886-9876-3325<br />
								<img src="https://i.imgur.com/rFmwESc.png" width="15">
								islandbrigade@gmail.com
							</div>
						</div>
					</aside>
				</div>
