...
<body>
 ...
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/RmtypeServlet" style="margin-bottom: 0px;">
    ...
    <div class="avt_detail">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <img src="<%=request.getContextPath()%>/RtpServlet?roomCategoryId=${rtVO.roomCategoryId}" alt="Jane" style="width: 100%">
        </div>
        <div class="col-md-6 col-sm-12">
          <br>
          ...
          <div class="text-right more">
            ...
            <div class="modal fade" id="modal-id-super-activity-type-update">
              <div class="modal-dialog">
                ...
                <font color='red'>*系統將帶入您的個人資料?&nbsp;
                <input type="checkbox" name="personal_data" id="personal_data">確認  
                   </font>
                   </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9" id="room_date">
                      <input type="date" class="form-control short" />&nbsp;&nbsp;至&nbsp;&nbsp;<input type="date" class="form-control short" />
                    </div>
                    <label class="control-label col-sm-3" for="date">
                      <font color='red'>*</font>&nbsp;預定入住時間：
                    </label>
					<div class="col-sm-9" id="room_date">
                     <input type="time" class="form-control short" min="15:00" max="18:00" required>
                    </div>
                  </div>
                  <br>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-info" data-dismiss="modal">送出</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="row">
    <p align="center">
      <br>
      <a href="<%=request.getContextPath()%>/RmtypeServlet?action=getAllRoomType" class="btn btn-primary " role="button">回到訂房列表</a>
    </p>
  </div>
