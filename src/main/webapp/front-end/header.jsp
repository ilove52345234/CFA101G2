		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-left" style="flex-direction: row;">
					...
					<li><a href="<%=request.getContextPath()%>/rmtype/RmtypeServlet?action=getAllRoomType">線上訂房</a></li>
					<li><a href="<%=request.getContextPath()%>/front-end/act/listAllActType2.jsp">預定活動</a></li>
				...
				<ul class="nav navbar-nav navbar-right" style="flex-direction: row;">
					...
					<li>
						...
						<c:if test="${memVO != null}">
							...
							<form id="form1" method="post" action="<%=request.getContextPath()%>/front-end/mem/mem.do" name="form1">
					...
					<li>
						<c:if test="${memVO != null}">
							...
							<FORM id="form2" METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/mem/mem.do">
