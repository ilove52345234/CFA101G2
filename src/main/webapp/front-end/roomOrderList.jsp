    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="td4">${roomName}</td>
          <td class="td4">${bookRmoVO.roomPrice}元</td>
        </tr>
        <tr>
...
<input type="submit" class="press-confirm" name="按鈕名稱" value="確定">&nbsp; <input type="submit" class="press-confirm" name="按鈕名稱" value="修改">
</div>
<br>
</div>
