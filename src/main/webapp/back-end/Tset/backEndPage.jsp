...
<!-- 					data-target="#myNavbar"> -->
				...
				<!-- 點擊商標跳轉至首頁 #要放首頁網址 -->
				<a class="navbar-header" href="#"> <img src="https://i.imgur.com/2j6Zzxv.png" height="40" title="島旅 Island Travel" alt="島旅 Island Travel"></a>
			</div>
					...
					<li><a href="#">商城管理<span class="caret"></span></a>
						<ul>
							<li class="dropdown-submenu"><a class="test" tabindex="-1"
								...
								<ul class="dropdown-menu">
									<li><a tabindex="-1" href="../shop/searchCommodity.jsp">商品資料管理</a></li>
									<li><a tabindex="-1" href="../shop/addCommodityContent.jsp">商品建檔</a></li>
								</ul></li>
							<li class="dropdown-submenu"><a class="test" tabindex="-1"
