...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/emp/addEmpServlet" method="post">
        <div class="form-group">
            <label for="empName">姓名：</label>
            <input type="text" class="form-control" id="empName" name="empName" value="${empVO.empName}" placeholder="請輸入姓名">
        </div>

        <div class="form-group">
            <label for="empAccount">帳號：</label>
            <input type="text" class="form-control" id="empAccount" name="empAccount" value="${empVO.empAccount}" placeholder="請輸入帳號">
        </div>
        <div class="form-group">
            <label for="empPassword">密碼：</label>
            <input type="password" class="form-control" id="empPassword" name="empPassword" value="${empVO.empPassword}" placeholder="請輸入密碼">
        </div>
        ...
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${list}" var="list" varStatus="s">
                <tr>
                    <td><input type="checkbox" value="${list.funcId}" name="funs" id="funs${s.count}"/>
