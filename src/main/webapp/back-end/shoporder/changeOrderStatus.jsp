...
<FORM METHOD="post" id="update_form" ACTION="shoporder.do" name="form1">
	...
	<input type="hidden" name="paymentMethod" value="<%=shopOrderVO.getPaymentMethod()%>">
	<input type="hidden" name="shippingMethod" value="<%=shopOrderVO.getShippingMethod()%>">
