    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-header" href="/CFA101G2/back-end/index.html"> <img src="https://i.imgur.com/INGDvWS.png" height="40"
                                                    title="島旅 Island Travel" alt="島旅 Island Travel"></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <li><a href="#">訂房管理<span class="caret"></span></a>
                    <ul>
                        <li><a class="test" tabindex="-1"
                               href="/CFA101G2/back-end/roomsorder/roomsorderList.html">住房管理</a>
                        </li>
                        <li><a class="test" tabindex="-1"
                               href="/CFA101G2/back-end/roomtype/room_list.html">房型管理</a>
                        </li>
                        <li><a class="test" tabindex="-1"
                               href="/CFA101G2/room/roomServlet">房間管理</a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:if test="${emp==null}">
                    <li><a href="/CFA101G2/back-end/login.html"><span class="glyphicon glyphicon-user"></span>
                        管理員登入</a></li>
                </c:if>
                <c:if test="${emp!=null}">
