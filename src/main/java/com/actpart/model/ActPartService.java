...
public class ActPartService {
	...
	public ActPartVO addActPart(Integer actId, Integer memId,
	...
	public List<ActPartVO> getAllPartsByActId(Integer actId) {
			return (List<ActPartVO>)dao.getAllByActId(actId);
	}
