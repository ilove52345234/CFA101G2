...
public class ActServlet2 extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_actId".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				/***************************3.查詢完成,準備轉交(Send the Success view)************/
				req.setAttribute("actVO", actVO);         // 資料庫取出的empVO物件,存入req
				String url = "/front-end/act/addActPart.jsp";
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			try {
				...
				/***************************2.開始修改資料*****************************************/
				ActService actSvc = new ActService();
				actVO = actSvc.updateAct2(actId, actCategoryId, actPromotionId, actDescription, actStart, actEnd, actStatus,
        ...
        if ("insert".equals(action)) { // 來自addEmp.jsp的請求  
			...
			try {
				...
				/***************************2.開始新增資料***************************************/
				ActService actSvc = new ActService();
				actVO = actSvc.addAct2(actCategoryId, actPromotionId, actDescription, actStart, actEnd, actStatus,
									  actFee, applicants, partStart, partEnd, actMaxPart, actMinPart);
