 ...
 */
@WebServlet("/act/CancelActServlet")
public class CancelActServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if("cancelActFake".equals(action)){
