...
//		doGet(req, res);   使用/RtpServlet?roomCategoryId=${rtVO.roomCategoryId}傳遞方式 所以不能用
...
//		String action = req.getParameter("action");
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
					"SELECT ROOM_PHOTO FROM ROOM_TYPE_PIC WHERE ROOM_CATEGORY_ID = " + myPhoto + " limit 1");
