...
public class ImageZipUtil {  
	...
	public static void main(String[] args) {
		for(int i=1;i<10;i++){
//			for(int j=1;j<=5;j++){
				zipWidthHeightImageFile(new File("/Users/lianghung/Desktop/imagesout/"+i+".jpg"),new File("/Users/lianghung/Desktop/專題圖片存檔/"+i+".jpg"),600,425,1f);
...
//		zipWidthHeightImageFile(new File("/Users/lianghung/Desktop/images"),new File("/Users/lianghung/Desktop/專題圖片存檔"),659,439,1f);
